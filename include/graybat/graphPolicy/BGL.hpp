...
class BGL {
  ...
  private:
    using GraphType = boost::adjacency_list<boost::vecS, boost::vecS, boost::bidirectionalS, boost::property<boost::vertex_index_t, size_t, std::pair<graybat::graphPolicy::VertexID, T_VertexProperty>>, boost::property<boost::edge_index_t, size_t, std::pair<graybat::graphPolicy::EdgeID, T_EdgeProperty>>>;
  ...
  public:
     ...
     *
     * If this graph has no supergraph (hasSuperGraph()==false) then local ids are the same as
     * global ids.
     */
