...
template <class T_Cage> struct CommunicationVertex {
    ...
    template <class T_Data> void spread(const T_Data& data, std::vector<Event>& events)
    {
        cage.spread(*this, data, events);
    }

    template <class T_Data> void spread(const T_Data& data)
    {
        cage.spread(*this, data);
    }

    template <class T_Data> void collect(T_Data& data)
    {
        cage.collect(*this, data);
    }

    template <class T_Data, class T_Functor> void forward(T_Data& data, T_Functor f)
    {
        cage.collect(*this, data);
        f(data);
        cage.spread(*this, data);
    ...
    template <class T_Data> void forward(T_Data& data)
    {
